...
4. [Add tests for your changes](https://github.com/djoos-cookbooks/newrelic_meetme_plugin/blob/master/TESTING.md)
4. Push your changes to your feature branch (`git push origin my-new-feature`)
5. Create a new PR (Pull Request)

## Testing
Contributions will only be accepted if they are fully tested as specified in [TESTING.md](https://github.com/djoos-cookbooks/newrelic_meetme_plugin/blob/master/TESTING.md).
